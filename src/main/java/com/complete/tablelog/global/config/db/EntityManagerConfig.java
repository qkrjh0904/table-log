package com.complete.tablelog.global.config.db;
...
@Configuration
@EnableJpaAuditing
@EntityScan(basePackages = {"com.complete.tablelog"})
@EnableJpaRepositories(basePackages = {"com.complete.tablelog"})
@RequiredArgsConstructor
public class EntityManagerConfig {

    private static final String[] PACKAGE_TO_SCAN = {"com.complete.tablelog"};
